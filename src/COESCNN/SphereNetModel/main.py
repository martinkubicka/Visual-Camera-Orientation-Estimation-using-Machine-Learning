...
from imports import *
from dataset import SphereNetModelDataset
from model import SphereNetModel
...
def main():    
    ...
    train_dataset = SphereNetModelDataset(data_dir, transform=transform, train=True)
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)
        
    test_dataset = SphereNetModelDataset(data_dir, transform=transform, train=False)
    test_dataloader = DataLoader(test_dataset, batch_size=batch_size, shuffle=True)
        
    model = SphereNetModel()
