...
class MergedModel(nn.Module):
    def __init__(self):
        ...
        # merging layer
        self.fc_merge = nn.Linear(64 * 13 * 13 * 2, 256)
...
def main():
    ...
    data_dir = "../preprocessing/dataImagesFromPanoramas/"
    ...
    test_loader = DataLoader(test_dataset, batch_size=128, shuffle=False, **kwargs)
